...
The package is registered in the Python package index (PyPI) as "scikits.scattpy":http://pypi.python.org/pypi/scikits.scattpy/0.1.0 and can be automatically installed using the standard tools such as @pip@ and @easy_install@. Please refer to the "download":/downloads/ page for instructions on manual download and installation.
